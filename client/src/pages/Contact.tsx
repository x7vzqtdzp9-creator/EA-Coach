...
export default function Contact() {
  return (
    <div className="min-h-screen bg-[oklch(0.18_0.055_250)]">
      ...
      <section className="pt-40 pb-28 relative overflow-hidden" style={{ background: "oklch(0.18 0.055 250)" }}>
        <div
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <AnimatedSection direction="left">
              <div>
                ...
                <h1 className="font-display text-white mb-6" style={{ fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 500 }}>
                  Parlons de votre{" "}
                ...
                <p className="font-body text-white/70 mb-6 max-w-xl" style={{ fontSize: "1.05rem", lineHeight: 1.8 }}>
                ...
                <p className="font-body text-white/65 mb-10 max-w-xl" style={{ fontSize: "1.05rem", lineHeight: 1.8 }}>
                ...
                <div className="space-y-5">
                  <a href="mailto:contact@eacoach.fr" className="flex items-center gap-4 group">
                    ...
                    <div>
                      <div className="font-nav text-white/40" style={{ fontSize: "0.65rem", letterSpacing: "0.1em" }}>
                        EMAIL
                      </div>
                      <div className="font-body text-white group-hover:text-[oklch(0.72_0.10_78)] transition-colors duration-200" style={{ fontSize: "1rem" }}>
                        contact@eacoach.fr
                      </div>
                    </div>
                  </a>
            ...
            <AnimatedSection direction="right" delay={150}>
              <div className="p-8 border border-white/10" style={{ background: "oklch(0.22 0.06 250 / 0.6)" }}>
                <h2 className="font-display text-white mb-4" style={{ fontSize: "1.5rem", fontWeight: 500 }}>
                  Envoyez-nous un message
                </h2>
                <p className="font-body text-white/60 mb-6" style={{ fontSize: "0.95rem", lineHeight: 1.7 }}>
      ...
      <section className="py-20 bg-[oklch(0.97_0.005_85)]">
        <div className="container">
          <AnimatedSection>
            ...
            <span className="gold-line mb-6" />
            <h2 className="font-display text-[oklch(0.18_0.04_250)] mb-10 max-w-4xl" style={{ fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 500 }}>
            ...
            {steps.map((step, index) => (
              <AnimatedSection key={step.title} delay={index * 120}>
                <div className="bg-white border border-[oklch(0.88_0.01_250)] p-8 h-full hover:shadow-xl transition-all duration-300">
                  ...
                  <h2 className="font-display text-[oklch(0.18_0.04_250)] mb-4" style={{ fontSize: "1.3rem", fontWeight: 600 }}>
                    {step.title}
                  </h2>
                  <p className="font-body text-[oklch(0.45_0.04_250)]" style={{ fontSize: "0.98rem", lineHeight: 1.75 }}>
                    {step.text}
                  </p>
                </div>
              </AnimatedSection>

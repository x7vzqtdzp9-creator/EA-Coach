    ...
    <div className="min-h-screen bg-[oklch(0.97_0.005_85)]">
      ...
      >
        <div
          ...
          style={{
            backgroundImage: `url(/ocean-horizon.webp)`,
        ...
        <div className="container relative z-10">
          <div className="max-w-2xl">
            <div className="font-nav text-[oklch(0.72_0.10_78)] mb-4" style={{ fontSize: "0.7rem", letterSpacing: "0.2em" }}>
              RESSOURCES & RÉFLEXIONS
            </div>
            <h1 className="font-display text-white mb-6" style={{ fontSize: "clamp(2.2rem, 5vw, 3.5rem)", fontWeight: 500, lineHeight: 1.15 }}>
              Le Blog <span className="italic text-[oklch(0.72_0.10_78)]">EA Coach</span>
            </h1>
            <p className="font-body text-white/65" style={{ fontSize: "1.05rem", lineHeight: 1.8 }}>
        ...
        <div className="container">
          {isLoading ? (
            ...
            <div className="text-center py-24">
              ...
              <h2 className="font-display text-[oklch(0.22_0.06_250)] mb-3" style={{ fontSize: "1.6rem", fontWeight: 500 }}>
                Bientôt disponible
              </h2>
                    ...
                    <div className="p-8 flex flex-col flex-1">
                      {post.category && (
                        <div className="flex items-center gap-2 mb-4">
                          ...
                          <span className="font-nav text-[oklch(0.72_0.10_78)]" style={{ fontSize: "0.65rem", letterSpacing: "0.15em" }}>
                            {post.category.toUpperCase()}
                          </span>
                        </div>
                      )}
                      <h2 className="font-display text-[oklch(0.18_0.04_250)] mb-3 group-hover:text-[oklch(0.55_0.12_235)] transition-colors duration-200" style={{ fontSize: "1.2rem", fontWeight: 600, lineHeight: 1.35 }}>
                        {post.title}
                      </h2>
                      {post.excerpt && (
                        <p className="font-body text-[oklch(0.50_0.04_250)] flex-1 mb-6" style={{ fontSize: "0.9rem", lineHeight: 1.7 }}>
                          {post.excerpt}
                        </p>
                      )}
                      <div className="flex items-center justify-between mt-auto pt-4 border-t border-[oklch(0.92_0.01_250)]">
                        ...
                        <span className="font-nav text-[oklch(0.55_0.12_235)] group-hover:text-[oklch(0.72_0.10_78)] flex items-center gap-1 transition-colors duration-200" style={{ fontSize: "0.65rem", letterSpacing: "0.1em" }}>
      ...
      <section className="py-16" style={{ background: "oklch(0.14 0.045 250)" }}>
        <div className="container text-center">
          ...
          <a href="/#contact" className="inline-flex items-center gap-3 font-nav text-[oklch(0.18_0.04_250)] bg-[oklch(0.72_0.10_78)] hover:bg-[oklch(0.78_0.08_85)] px-8 py-4 transition-all duration-300" style={{ fontSize: "0.75rem", letterSpacing: "0.15em", fontWeight: 700 }}>
            NOUS CONTACTER
            <ArrowRight size={14} />
          </a>
        </div>

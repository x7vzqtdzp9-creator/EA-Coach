...
/**
 * Blog posts table for the EA Coach blog.
...
/**
 * Admin accounts for blog management — independent of Manus OAuth.
 * Allows any user to log in with email + password without a Manus account.
 */
